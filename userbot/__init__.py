...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/e3572ed479c4f7db08e21.jpg"
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/thismn/Mon-Userbot")
...
# Untuk Perintah .myalive
MY_TEKS_KUSTOM = os.environ.get("MY_TEKS_KUSTOM", "I'am Using Mon-Userbot✨")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/e3572ed479c4f7db08e21.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/e3572ed479c4f7db08e21.jpg"
    ...
    try:
        ...
        main_help_button = [
            [
                ...
                Button.inline("ᴠᴏɪᴄᴇ ᴄʜᴀᴛ", data="mon_inline"),
            ],
            [
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ ᴍᴏɴ-ᴜsᴇʀʙᴏᴛ ɪɴʟɪɴᴇ ᴍᴇɴᴜ ✨**\n\n✣ **ᴏᴡɴᴇʀ** [{user.first_name}](tg://user?id={user.id})\n✣ **ᴊᴜᴍʟᴀʜ** `{len(dugmeler)}` **Modules**"
                await event.edit(
                    text,
                    file=mylogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@MonUserbot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                ...
                result = builder.article(
                    ...
                    url="https://t.me/ktsingkat",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**Mon-Userbot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **ᴏᴡɴᴇʀ ʀᴇᴘᴏ :** [Mon](https://t.me/lupakebot)\n✣ **sᴜᴘᴘᴏʀᴛ :** @ktsingkat\n✣ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [Github](https://github.com)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ꜱᴜᴘᴘᴏʀᴛ",
                                "https://t.me/ktsingkat"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com"),
                        ],
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:  # @Mon-Userbot
        ...
        @tgbot.on(events.CallbackQuery(data=b"mon_inline"))
        async def about(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                await event.edit(f"""
**✨ ᴍᴏɴ-ᴜsᴇʀʙᴏᴛ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴍᴇɴᴜ ✨**\n\n✣ **ᴏᴡɴᴇʀ :** [{user.first_name}](tg://user?id={user.id})
""",
                                 buttons=[
                                     [
...
""")
                await event.edit(
                    ...
                    file=mylogo,
                    link_preview=True,
                    buttons=[Button.inline("ʙᴀᴄᴋ", data="mon_inline")])
            else:
                reply_pop_up_alert = f"❌ DISCLAIMER ❌\n\nAnda Tidak Mempunyai Hak Untuk Menekan Tombol Button Ini"
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
            ...
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                await event.edit(
                    reply_pop_up_alert, buttons=[
                        Button.inline("ᴋᴇᴍʙᴀʟɪ", data="get_back")]
                )
