...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, my_cmd


@my_cmd(pattern="download(?: |$)(.*)")
...
@my_cmd(pattern="uploadas(stream|vn|all) (.*)")
