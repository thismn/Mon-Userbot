...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/thismn/Mon-Userbot"
# ============================================
...
@my_cmd(pattern="shutdown$")
async def killdabot(event):
    """ For .shutdown command, shut the bot down."""
    await edit_or_reply(event, "`Mematikan Mon-Userbot....`")
...
@my_cmd(pattern="restart$")
async def killdabot(event):
    await edit_or_reply(event, "`Restarting Userbot...`")
...
@my_cmd(pattern="readme$")
async def reedme(e):
    await edit_or_reply(e,
                        "Here's Something for You to Read :\n"
                        "\n[✨ Userbot Repo](https://github.com)"
                        "\n[Setup Guide - Basic](https://telegra.ph/How-to-host-a-Telegram-Userbot-11-02)"
                        "\n[Special - Note](https://telegra.ph/Special-Note-11-02)")


@my_cmd(pattern="repeat (.*)")
...
@my_cmd(pattern="string$")
async def repo_is_here(wannasee):
    """For .repo command, just returns the repo URL."""
    await edit_or_reply(wannasee,
                        f"✥ **GET STRING VIA BOT :**\n"
                        f"ㅤㅤㅤ- [KLIK DISINI](https://t.me/stringxxbot) -\n"
                        f"✥ **GET STRING VIA REPLIT :**\n"
                        f"ㅤㅤㅤ- [KLIK DISINI](https://replit.com) -\n"
                        )
...
CMD_HELP.update({
    ...
    \n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}sleep`\
    \n↳ : Biarkan Userbot tidur selama beberapa detik.",
