...
CMD_HELP.update({
    "animasi4":
    f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}bulan` ; `{cmd}hati` ; `{cmd}bernyanyi`\
    \n↳ : liat aja.\
    \n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}helikopter` ; `{cmd}tank` `{cmd}tembak`\n`{cmd}bundir`\
    \n↳ : liat sendiri\
    \n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}y`\
    \n↳ : jempol\
    \n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}awkwok`\
    \n↳ : ketawa lari.\
    \n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}ular` ; `{cmd}babi` ; `{cmd}ajg`\
    \n↳ : liat sendiri."
})
