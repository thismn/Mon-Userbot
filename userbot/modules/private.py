    ...
    if event.query.user_id == OWNER_ID:
        ...
        with io.BytesIO(str.encode(msg)) as fileuser:
            ...
            await tgbot.send_file(
                ...
                fileuser,
                force_document=True,
                thumb="userbot/resources/IMG_20211216_160240_756.jpg",
    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 Hai** {mention}**!**\
                        ...
                        \n**Jangan spam atau anda akan di Banned**\
                        \n\n**ᴘᴏᴡᴇʀᴇᴅ ʙʏ**: [ᴍσɴ-υѕєявσт](https://github.com)"
            buttons = [
                (
...
async def infor(event):
    await tgbot.send_message(
        event.chat_id,
        message=f"Bot ini adalah bot asisten {OWNER}\
                \n\n➭ **ꜱᴜᴘᴘᴏʀᴛ** : [ᴄʜᴀɴɴᴇʟ](https://t.me/ktsingkat)\
                \n➭ **ᴘᴏᴡᴇʀᴇᴅ ʙʏ** : ᴍσɴ-υѕєявσт",
        buttons=[
            [
                custom.Button.inline(
                    "ᴄʟᴏꜱᴇ",
