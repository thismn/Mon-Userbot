...
@my_cmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@my_cmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@my_cmd(pattern=r"^\.insult$")
async def insult(e):
...
@my_cmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@my_cmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@my_cmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@my_cmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@my_cmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@my_cmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@my_cmd(pattern=r"^\.metoo$")
...
@my_cmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@my_cmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@my_cmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@my_cmd(pattern=r"^\.moon$")
...
@my_cmd(pattern=r"^\.taco$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >🌮 Want a taco?")


@my_cmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")
...
CMD_HELP.update(
    {
        ...
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}coinflip <heads/tails>`"
        "\nUsage: Flip a coin !!"
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}owo`"
        "\nUsage: UwU"
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}react`"
        "\nUsage: Make your userbot react to everything."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}slap | {cmd}slap id | {cmd}slap jutsu`"
        ...
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}clap`"
        "\nUsage: Praise people!"
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}f <emoji/character>`"
        "\nUsage: Pay Respects."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}bt`"
        "\nUsage: Believe me, you will find this useful."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}type`"
        "\nUsage: Just a small command to make your keyboard become a typewriter!"
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}lfy <query>`"
        "\nUsage: Let me Google that for you real quick !!"
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}decide [Alternates: ({cmd}yes, {cmd}no, {cmd}maybe)]`"
        "\nUsage: Make a quick decision."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}scam <action> <time>`"
