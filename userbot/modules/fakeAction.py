...
async def _(event):
    ...
    xx = await edit_or_reply(event, f"`Memulai Pengetikan Palsu Selama {t} sec.`")
    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await edit_delete(event, "`Incorrect Format`")
    xx = await edit_or_reply(event, f"`Memulai merekam audio palsu Selama {t} sec.`")
    await asyncio.sleep(3)
    await xx.delete()
    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await edit_delete(event, "`Incorrect Format`")
    xx = await edit_or_reply(event, f"`Memulai merekam video palsu selama {t} sec.`")
    await asyncio.sleep(3)
    await xx.delete()
    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await edit_delete(event, "`Incorrect Format`")
    xx = await edit_or_reply(event, f"`Memulai Bermain Game Palsu Selama {t} sec.`")
    await asyncio.sleep(3)
    await xx.delete()
